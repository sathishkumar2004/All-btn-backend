...
var CreatableSelect = function (_React$Component) {
	...
	function CreatableSelect(props, context) {
		...
		_this.allowCreate = props.allowCreate;
	...
	createClass(CreatableSelect, [{
		...
		value: function filterOptions$$1() {
			...
			if (this.allowCreate) {
				...
				filteredOptions = filterOptions$$1.apply(undefined, arguments) || [];
				...
				if (isValidNewOption({ label: this.inputValue })) {
					...
					if (_isOptionUnique2) {
						var prompt = promptTextCreator(this.inputValue, this.allowCreate);
		...
		value: function onInputKeyDown(event) {
			...
			if (focusedOption && focusedOption === this._createPlaceholderOption && shouldKeyDownEventCreateNewOption({ keyCode: event.keyCode })) {
				if (this.allowCreate) this.createNewOption();
...
function promptTextCreator(label, allowCreate) {
	if (!allowCreate) return 'Nenhum resultado encontrado.';
